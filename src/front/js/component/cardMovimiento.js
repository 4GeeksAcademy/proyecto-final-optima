...
export const CardMovimientos = (props) => {
    ...
    return (
        <div className="card mb-3" key={props.id}>
            <div className="card-2 row g-0 align-items-center text-center w-100">
                <div className="col-md-4 col-lg-4">
                    <h4 className="mb-1"><strong>{props.accountName}</strong></h4>
                    <p className="mb-1">{props.detail}</p>
                </div>
                <div className="amount-coin col-md-3 col-lg-3">
                ...
                <div className="buttons-edit-delete btn-group-vertical col-md-2 d-flex flex-column col-lg-2" role="group" aria-label="Vertical button group">
                    <button
                        type="button"
